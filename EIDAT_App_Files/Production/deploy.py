...
def _render_eidat_bat(*, runtime_root: Path) -> str:
    ...
    return (
        ...
        "\r\n"
        "rem Ensure a usable working directory (maps UNC to a temp drive letter).\r\n"
        "pushd \"%~dp0\" >nul 2>nul\r\n"
        "if errorlevel 1 (\r\n"
        "  echo [ERROR] Failed to access script directory: \"%~dp0\"\r\n"
        "  exit /b 1\r\n"
        ")\r\n"
        "\r\n"
        "set \"HERE=%CD%\\\"\r\n"
        ...
        "\r\n"
        "rem Locate EIDAT_App_Files.\r\n"
        "rem Prefer the configured RUNTIME_ROOT, but allow the node to be moved/copied within a shared repo.\r\n"
        'set "APP_ROOT=%RUNTIME_ROOT%\\EIDAT_App_Files"\r\n'
        "if not exist \"%APP_ROOT%\\Production\\requirements-node-ui.txt\" (\r\n"
        "  for %%I in (\"%NODE_ROOT%\\..\\..\\..\") do set \"RUNTIME_ROOT=%%~fI\"\r\n"
        "  set \"APP_ROOT=%RUNTIME_ROOT%\\EIDAT_App_Files\"\r\n"
        ")\r\n"
        "if not exist \"%APP_ROOT%\\Production\\requirements-node-ui.txt\" (\r\n"
        "  echo [ERROR] EIDAT_App_Files not found.\r\n"
        "  echo         Set RUNTIME_ROOT to the folder that contains EIDAT_App_Files.\r\n"
        "  echo         Current RUNTIME_ROOT: \"%RUNTIME_ROOT%\"\r\n"
        "  popd >nul 2>nul\r\n"
        "  exit /b 1\r\n"
        ")\r\n"
        "\r\n"
        ...
        "\r\n"
        "if exist \"%VENV_PY%\" goto :eidat_run\r\n"
        "\r\n"
        "rem No venv yet; bootstrap using a system Python.\r\n"
        "set \"SYS_PY_EXE=\"\r\n"
        "set \"SYS_PY_ARGS=\"\r\n"
        "\r\n"
        ...
        ":eidat_have_sys_py\r\n"
        "if not defined SYS_PY_EXE (\r\n"
        "  echo [ERROR] Python 3 not found (required to create the node venv).\r\n"
